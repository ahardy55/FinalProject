...
class UsercommentsControllerTest < ActionController::TestCase
  ...
  test "should create usercomment" do
    assert_difference('Usercomment.count') do
      post :create, usercomment: { bioguide_id: @usercomment.bioguide_id, comment: @usercomment.comment, user_id: @usercomment.user_id }
    end
  ...
  test "should update usercomment" do
    put :update, id: @usercomment, usercomment: { bioguide_id: @usercomment.bioguide_id, comment: @usercomment.comment, user_id: @usercomment.user_id }
    assert_redirected_to usercomment_path(assigns(:usercomment))
  end
